...
CREATE TABLE galaxy (galaxy_id SERIAL NOT NULL, description TEXT, name character varying(255), distance_from_earth FLOAT,escape_velocity_at_sun NUMERIC (10, 2));
...
CREATE TABLE moon (moon_id SERIAL PRIMARY KEY NOT NULL, name VARCHAR(255),    description TEXT, age INT,    distance_from_earth FLOAT);
