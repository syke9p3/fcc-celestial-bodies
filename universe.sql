...
INSERT INTO public.moon VALUES (18, 'Triton', 'Triton is the largest natural satellite of the planet Neptune. It is the only moon of Neptune massive enough to be rounded under its own gravity and hosts a thin but well-structured atmosphere. Triton orbits Neptune in a retrograde orbit— revolving in the opposite direction to the parent planet''s rotation — the only large moon in the Solar System to do so.', NULL, NULL, 8);
INSERT INTO public.moon VALUES (19, 'Despina', 'Despina is a tiny moon, measuring only 148 kilometers in diameter, and is irregularly shaped, with a heavily cratered surface and an elongated, distorted shape.', NULL, NULL, 8);
INSERT INTO public.moon VALUES (20, 'Galatea', 'Galatea is a small moon of Neptune. It is one of Neptune''s inner moons and is the third closest moon to orbit the planet. Galatea has a diameter of approximately 175 kilometres (109 miles). It orbits Neptune at a distance of just over 61,500 kilometres (38,300 miles). A length of an orbit takes only 10 hours which means that it orbits Neptune faster than the planet spins.', NULL, NULL, 8);
INSERT INTO public.moon VALUES (21, 'Halimede', 'Halimede is an outer irregular, retrograde moon of Neptune. It could be a captured asteroid or a fragment of the moon Nereid. Its diameter is around 60 km. It appears neutral grey in color and is made of water ice with some impurities. Not much is known about Halimede, except that it orbits Neptune in a highly inclined plain, retrograde and with an elliptical orbit. Being so small, it cannot be spherical. Also, it is not tidal locked. Given its small size, there is a high chance that it has a chaotic rotation.', NULL, NULL, 8);
